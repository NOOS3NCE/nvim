...
_G.packer_plugins = {
  ...
  ["blamer.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/blamer.nvim",
  ...
  getpr = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/getpr",
    url = "https://github.com/skanehira/getpr"
  },
  ["getpr.vim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/getpr.vim",
